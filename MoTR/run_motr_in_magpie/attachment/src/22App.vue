...
<template>
  <Experiment title="Mouse tracking for Reading">
    ...
    <Screen :title="'Здравствуйте!'" class="instructions" :validations="{
        SubjectID: {
        ...
        <p> Спасибо, что участвуете в нашем эксперименте. Сейчас мы перейдём к калибровке камеры.
        <br><br>
        Во время калибровки мы попросим вас смотреть на маленькую белую точку в середине чёрного кружка. Она будет передвигаться по экрану, а ваша задача - следить за ней глазами. Не пытайтесь угадать, где точка появится в следующий момент, просто смотрите на неё, пока она не исчезнет. Когда точка появится в другом месте на экране, переведите на неё взгляд.
        <br><br>
        Инструкцию о том, как проходить эксперимент, вы увидите после калибровки. Нажмите любую кнопку мыши, чтобы начать.
        <br><br>
...
import localCoherence_list1 from '../trials/Russ_MoTR_List1.tsv'; // For now I use a demo list data fro all possible lists + practice list.
